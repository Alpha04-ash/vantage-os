    ...
    <SceneContainer opacity={opacity}>
      <motion.div style={{ y }} className="flex flex-col items-center justify-center text-center px-6">
        <h1 className="text-4xl md:text-6xl font-light tracking-widest text-zinc-400">
          Modern finance makes <span className="text-white font-medium">consumers</span>.
        </h1>
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tighter mt-12 text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-200 to-gray-500">
          VANTAGE makes <span className="text-[#F0B90B]">sovereign operators</span>.
        </h1>
        ...
        >
          <span>Scroll down to explore the platform</span>
  ...
  return (
    <SceneContainer opacity={opacity}>
      <motion.div style={{ scale }} className="text-center">
        ...
        <p className="text-5xl font-black text-white tracking-tighter uppercase mt-4">But true intelligence is rare.</p>
      </motion.div>
    </SceneContainer>
  );
};
    ...
    <SceneContainer opacity={opacity}>
      <motion.div style={{ y }} className="flex flex-col items-center gap-4">
        ...
        <div className="flex gap-4 md:gap-6 mt-6 font-mono text-xs md:text-sm tracking-widest text-[#F0B90B] opacity-80 flex-wrap justify-center">
          ...
          <span>INDUSTRIAL SIMULATION</span>
          <span className="hidden md:inline">//</span>
      ...
      <motion.div style={{ x }} className="w-full flex justify-start px-8 md:px-32">
        <div className="max-w-2xl border-l-2 border-[#F0B90B] pl-8 bg-[#1E2026]/80 p-8 backdrop-blur-sm">
          <p className="text-[#F0B90B] font-mono mb-4 text-sm tracking-widest flex items-center gap-2">
            ...
            01 / OVERVIEW & NET WORTH
          </p>
          <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-6 uppercase text-white">ABSOLUTE COMMAND.</h2>
          <p className="text-lg md:text-xl text-zinc-400 font-light leading-relaxed">
            Centralized capital indexing. Direct mapping of cash distribution. Access to real-time portfolio risk assessment generated by Gemini AI.
          </p>
        </div>
      </motion.div>
    </SceneContainer>
      ...
      <motion.div style={{ x }} className="w-full flex justify-end px-8 md:px-32">
        <div className="max-w-2xl text-right border-r-2 border-[#F0B90B] pr-8 bg-[#1E2026]/80 p-8 backdrop-blur-sm">
          <p className="text-[#F0B90B] font-mono mb-4 text-sm tracking-widest justify-end flex items-center gap-2">
            02 / CRYPTO TRADING TERMINAL
            <Cpu className="w-4 h-4" />
          </p>
          <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-6 uppercase text-white">MULTI-ASSET ARBITRAGE.</h2>
          <p className="text-lg md:text-xl text-zinc-400 font-light leading-relaxed">
            Buy and sell volatile digital crypto assets such as Bitcoin, Ethereum, and Solana in a real-time trading terminal with automated indicators.
          </p>
        </div>
      </motion.div>
    </SceneContainer>
    ...
    <SceneContainer opacity={opacity}>
      <motion.div style={{ x }} className="w-full flex justify-start px-8 md:px-32">
        <div className="max-w-2xl border-l-2 border-[#F0B90B] pl-8 bg-[#1E2026]/80 p-8 backdrop-blur-sm">
          ...
          <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-6 uppercase text-white">MANAGE YOUR SIMULATION.</h2>
          <p className="text-lg md:text-xl text-zinc-400 font-light leading-relaxed">
            Acquire SaaS startups, DeFi nodes, PropTech projects, and AI clusters. Manage complex operational parameters to maximize cash flow growth.
          </p>
        </div>
      </motion.div>
    </SceneContainer>
    ...
    <SceneContainer opacity={opacity}>
      <motion.div style={{ x }} className="w-full flex justify-end px-8 md:px-32">
        <div className="max-w-2xl text-right border-r-2 border-[#F0B90B] pr-8 bg-[#1E2026]/80 p-8 backdrop-blur-sm">
          ...
          <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-6 uppercase text-white">FRACTIONAL BANKING.</h2>
          <p className="text-lg md:text-xl text-zinc-400 font-light leading-relaxed">
            Open active credit lines approved by the Gemini AI risk manager. Store funds in the treasury with a yield of 5.5% per month.
          </p>
        </div>
      </motion.div>
    </SceneContainer>
  ...
  return (
    <SceneContainer opacity={opacity}>
      <motion.div style={{ y }} className="text-center max-w-4xl bg-[#1E2026]/80 p-12 backdrop-blur-md border border-[#F0B90B]/10 rounded-sm mx-8">
        <p className="text-[#F0B90B] font-mono mb-4 text-sm tracking-widest uppercase">05 / AI FINANCIAL ACADEMY</p>
        <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-6 uppercase text-white">LEARN BY DOING.</h2>
        <p className="text-xl md:text-2xl text-zinc-400 font-light leading-relaxed mx-auto">
          Complete financial missions from crypto trading to banking, while a personalized Gemini AI tutor provides real-time guidance.
        </p>
      </motion.div>
    </SceneContainer>
  );
