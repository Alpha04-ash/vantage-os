      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="flex items-center gap-2 text-[9px] font-bold text-[#848E9C] uppercase tracking-wider font-mono">
                ...
                СИСТЕМАИ_СИНАПСӢ // NEURAL PULSE ACTIVE
              </span>
            </div>
            <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tight text-[#EAECEF] leading-none">
              <GlitchText text="АКАДЕМИЯИ МОЛИЯВӢ" />
            </h1>
          </div>
          
          <p className="text-xs md:text-sm text-[#848E9C] max-w-xl leading-relaxed">
            Механикаи мураккаби сарватмандиро тавассути протоколҳои симулятсионии хусусӣ ва модулҳои таълимии ИИ аз худ кунед. Ҳар як дарс барои баланд бардоштагони IQ-и молиявии шумо ва ба даст овардани муваффақият пешбинӣ шудааст.
          </p>
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#2B2F36] border border-[#474D57]/60 text-[10px] font-mono text-[#EAECEF]">
              ...
              <span>ЗЕҲНИ_ИСТИФОДАШУДА: ГЕМИНӢ ФЛЭШ</span>
            </div>
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#2B2F36] border border-[#474D57]/60 text-[10px] font-mono text-[#EAECEF]">
              <Award className="w-3.5 h-3.5 text-[#F0B90B]" />
              <span>МАҚОМ: ИМПЕРАТОРИ ОЯНДА</span>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-5 bg-[#2B2F36]/50 border border-[#474D57]/40 rounded-xl p-6 md:p-8 space-y-6">
          <div className="flex justify-between items-center">
            <span className="text-[10px] font-extrabold uppercase tracking-widest text-[#848E9C]">Ҷараёни Ҳамзамонсозӣ</span>
          ...
          <div className="grid grid-cols-2 gap-4 text-center font-mono">
            <div className="p-3 bg-[#1E2026]/60 rounded-lg border border-[#474D57]/30">
              <div className="text-[8px] font-bold text-[#848E9C] uppercase tracking-wider mb-1">МАСЪАЛАҲО</div>
              <div className="text-base font-bold text-[#EAECEF]">8 МОДУЛ</div>
            </div>
            <div className="p-3 bg-[#1E2026]/60 rounded-lg border border-[#474D57]/30">
              <div className="text-[8px] font-bold text-[#848E9C] uppercase tracking-wider mb-1">МУВАФФАҚИЯТ</div>
              <div className="text-base font-bold text-[#F0B90B]">
                {Math.round((progress / 100) * 8)} / 8 АНҶОМ
              </div>
            </div>
          </div>
        </div>
...
export function AcademyLessonCard({ lesson, status }: { lesson: Lesson, status: "locked" | "started" | "completed" }) {
  ...
  const statusText = status === "completed" ? "АНҶОМЁФТА" : status === "started" ? "ОҒОЗЁФТА" : "ҚУЛФ";
  const difficultyText = lesson.difficulty === "Beginner" ? "Мубтадӣ" : lesson.difficulty === "Intermediate" ? "Миёна" : "Пешрафта";
        ...
        <div className="mt-auto pt-6 border-t border-[#2B2F36] flex items-center justify-between">
          <div className="flex items-center gap-4 text-mono">
            <div className="flex flex-col">
              <span className="text-[7px] font-bold text-[#848E9C]/40 uppercase tracking-widest">ВАҚТ</span>
              <span className="text-[10px] font-bold text-[#EAECEF] tracking-wide">{lesson.estimatedMinutes} ДАҚ</span>
            </div>
            <div className="w-[1px] h-4 bg-[#2B2F36]" />
            <div className="flex flex-col">
              <span className="text-[7px] font-bold text-[#848E9C]/40 uppercase tracking-widest">САТҲ</span>
